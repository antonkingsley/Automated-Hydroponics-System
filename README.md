...
This project is licensed under the MIT License. See the  in [`MIT LICENSE`](#licence)<a id='https://github.com/antonkingsley/Automated-Hydroponics-System/tree/main?tab=MIT-1-ov-file#readme'>MIT LICENSE</a>
